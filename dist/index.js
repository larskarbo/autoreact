...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"@babel/runtime/regenerator\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"@babel/runtime/helpers/asyncToGenerator\");\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var progress__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! progress */ \"progress\");\n/* harmony import */ var progress__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(progress__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var child_process_promise__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! child-process-promise */ \"child-process-promise\");\n/* harmony import */ var child_process_promise__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(child_process_promise__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var args__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! args */ \"./node_modules/args/lib/index.js\");\n/* harmony import */ var args__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(args__WEBPACK_IMPORTED_MODULE_4__);\n\n\n\n\n\n\nvar fs = __webpack_require__(/*! fs-extra */ \"./node_modules/fs-extra/lib/index.js\");\n\nargs__WEBPACK_IMPORTED_MODULE_4___default.a.option('name', 'Project name').command('create', 'Create yeah');\nvar flags = args__WEBPACK_IMPORTED_MODULE_4___default.a.parse(process.argv);\nvar pwd = \"/Users/lars/dev\";\n\nvar command = function command(cmd) {\n  return new Promise(function (resolve, reject) {\n    console.log(cmd);\n    return Object(child_process_promise__WEBPACK_IMPORTED_MODULE_3__[\"exec\"])(\"cd \" + pwd + \" && \" + cmd).then(function (result) {\n      var stdout = result.stdout;\n      var stderr = result.stderr; // console.log('stdout: ', stdout);\n      // console.log('stderr: ', stderr);\n      // var stdout = result.stdout;\n      // var stderr = result.stderr;\n      // console.log('stdout: ', stdout);\n      // console.log('stderr: ', stderr);\n\n      return resolve(stdout);\n    })[\"catch\"](function (err) {\n      var stdout = err.stdout;\n      var stderr = err.stderr;\n      console.log('err: ', err);\n      console.log('stderr: ', stderr);\n      console.log('stdout: ', stdout);\n      console.log(\"⚠️------⚠️\");\n      reject('yo');\n    });\n  });\n};\n\nfunction hello() {\n  return _hello.apply(this, arguments);\n}\n\nfunction _hello() {\n  _hello = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(\n  /*#__PURE__*/\n  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {\n    var name, bar, dir, packageObj;\n    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            console.log(flags);\n            name = flags.name;\n            bar = new progress__WEBPACK_IMPORTED_MODULE_2___default.a(':bar', {\n              total: 10\n            });\n            dir = \"/Users/lars/dev/\" + flags.name;\n\n            if (!(typeof name == \"undefined\")) {\n              _context.next = 6;\n              break;\n            }\n\n            return _context.abrupt(\"return\", quit(\"You have to specify name you looser\"));\n\n          case 6:\n            _context.next = 8;\n            return fs.pathExists(dir);\n\n          case 8:\n            if (!_context.sent) {\n              _context.next = 10;\n              break;\n            }\n\n            return _context.abrupt(\"return\", quit(\"Folder already exists\"));\n\n          case 10:\n            _context.next = 12;\n            return command('cd ~/dev && npx create-react-app ' + name);\n\n          case 12:\n            pwd = \"/Users/lars/dev/\" + flags.name;\n            _context.next = 15;\n            return command('npx gitignore node ' + name);\n\n          case 15:\n            _context.next = 17;\n            return command('git init ' + name);\n\n          case 17:\n            _context.next = 19;\n            return command('hub create ' + name);\n\n          case 19:\n            _context.next = 21;\n            return command('yarn add gh-pages');\n\n          case 21:\n            _context.next = 23;\n            return command('yarn add --dev react-app-rewired customize-cra @babel/plugin-proposal-optional-chaining');\n\n          case 23:\n            _context.next = 25;\n            return fs.readJson(pwd + '/package.json');\n\n          case 25:\n            packageObj = _context.sent;\n            _context.next = 28;\n            return fs.copy('./config-overrides.js', pwd + '/config-overrides.js');\n\n          case 28:\n            packageObj.homepage = \"https://larskarbo.github.io/\" + name;\n            packageObj.scripts.predeploy = \"yarn build\";\n            packageObj.scripts.deploy = \"gh-pages -d build\";\n            packageObj.scripts.start = \"react-app-rewired start\";\n            packageObj.scripts.build = \"react-app-rewired build\";\n            packageObj.scripts.test = \"react-app-rewired test --env=jsdom\";\n            _context.next = 36;\n            return fs.outputJson(pwd + '/package.json', packageObj);\n\n          case 36:\n            _context.next = 38;\n            return command('yarn deploy');\n\n          case 38:\n            _context.next = 40;\n            return command('git ac  -m \"Create a React app and publish it to GitHub Pages\"');\n\n          case 40:\n            _context.next = 42;\n            return command('git push origin master');\n\n          case 42:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n  return _hello.apply(this, arguments);\n}\n\nfunction quit(str) {\n  console.log(\" ⚠️ quitting, \", str);\n}\n\nhello();\nvar co = \"\\nconst {\\n    override,\\n    addBabelPlugin,\\n} = require(\\\"customize-cra\\\");\\n\\nmodule.exports = override(\\n    addBabelPlugin(\\\"@babel/plugin-proposal-optional-chaining\\\")\\n)\\n\";\n\n//# sourceURL=webpack:///./index.js?");
